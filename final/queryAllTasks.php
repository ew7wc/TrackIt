...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
            url: "/~ew7wc/final/php/queryAllTasks.php",
                ...
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <ul class="list-inline headerButtons">
                            ...
                            <li>
                               <button class="btn btn-default btn-lg" disabled="disabled"><span class="section-name">All Incomplete Tasks</span></button>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="section-gray">
        <div class="container">
            ...
            <div class="col-md-10 col-md-offset-1">
                    <header>
                        <h2>All Tasks that are not completed (most recent due date to least)</h2>
                    </header>
